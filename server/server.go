...
// Option modifies the server
type Option func(*http.Server) error

var cache *lrucache.LRUCache

// NewServer returns a new server
func NewServer(options ...Option) (*http.Server, error) {
	srv := &http.Server{
		Addr:         "0.0.0.0:8080",
...
// WithAddr assigns the server address
...
// WithWriteTimeout assigns the server write timeout
...
// WithReadTimeout assigns the server read timeout
